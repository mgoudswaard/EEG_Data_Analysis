...
path = os.path.dirname(os.getcwd())+"/Pruned_data_test"
...
DigDes_Rest =  np.zeros((16,4),dtype=float)
...
np.savetxt(TRPpath+"DigDes_Rest_TRP.csv", DigDes_Rest,header="P1,P2,P3,P4",comments="", delimiter=',')

# For Physical Design - Resting TRP

PhysDes_Rest =  np.zeros((16,4),dtype=float)
...
np.savetxt(TRPpath+"PhysDes_Rest_TRP.csv", PhysDes_Rest,header="P1,P2,P3,P4",comments="", delimiter=',')

# For Digital Familiarisation - Resting TRP

DigFam_Rest =  np.zeros((16,4),dtype=float)
...
np.savetxt(TRPpath+"DigFam_Rest_TRP.csv", DigFam_Rest,header="P1,P2,P3,P4",comments="", delimiter=',')

# For Physical Familiarisation - Resting TRP
    
PhysFam_Rest =  np.zeros((16,4),dtype=float)
...
np.savetxt(TRPpath+"PhysFam_Rest_TRP.csv", PhysFam_Rest,header="P1,P2,P3,P4",comments="", delimiter=',')
